...
int Teclado(){
	...
	if((digitalRead(Enter))||(digitalRead(Arriba))||(digitalRead(Derecha))||(digitalRead(Abajo))||(digitalRead(Izquierda))){
...
display.println("puto el ");
display.setCursor(0,32);
display.println("que lee");
display.display();
}
void setup(){
	pinMode(Enter,INPUT);
